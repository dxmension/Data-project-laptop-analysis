...
class App:
    ...
    def assess_laptop(self, config: Dict[str, Dict[str, Union[str, float]]]) -> Dict[str, float]:
        """
    ...
    def show_sidebar(self, data: pd.DataFrame) -> Dict[str, Dict[str, Union[str, float]]]:
        """
    ...
    def show_main(self, data: pd.DataFrame) -> None:
        """
        ...
        laptop_configuration = self.show_sidebar(data)
        configurations = self.load_average_laptop()
        ...
        if toggle_configurator:
            laptop_assessment = self.assess_laptop(laptop_configuration)
            comparison_assessment = self.assess_laptop(comparison_configuration)
